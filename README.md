...
<ol align="left">
    <li>Writting and Reading data in a file</li>
    <li>Why Serialization?</li>
    <li>What is Serialization?</li>
    <li>Effectively using serialVersionUID</li>
    <li>Transient variables in Serialization</li>
    <li>Static variables in Serialization</li>
    <li>Custom Serialization</li>
    <li>Serialization in Inheritance</li>
    <li>Serialization in Association</li>
    <li>What is Externalizable?</li>
    <li>Serialization in Multi-threaded environment</li>
    <li>Uses of Serialization</li>
    <li>Advantages of Serialization</li>
    <li>Disadvantages of Serialization</li>
</ol>
...
<ul>
    ...
    <li><a href="https://youtu.be/1bSy1qxOFrM"
        target="_blank">Multithreading</a></li>
	<li><a href="https://youtu.be/bf9X_-qmcoY"
...
<p align="justify">
    ...
    Watch the complete video here: <a href="https://www.youtube.com/watch?v=z6r8lTvalvs"
        target="_blank"><b>Serialization</b></a>.
</p>
